...
# Datos de ejemplo (Clima, Temperatura, Viento, Deporte)
data = [
    ('Soleado', 'Caliente', 'Débil', 'Deportes al aire libre'),
    ('Soleado', 'Caliente', 'Fuerte', 'Deportes bajo techo'),
    ('Nublado', 'Caliente', 'Débil', 'Deportes al aire libre'),
    ('Lluvioso', 'Fresco', 'Débil', 'Deportes al aire libre'),
    ('Lluvioso', 'Frío', 'Débil', 'Deportes al aire libre'),
    ('Lluvioso', 'Frío', 'Fuerte', 'Deportes bajo techo'),
    ('Nublado', 'Fresco', 'Fuerte', 'Deportes bajo techo'),
    ('Soleado', 'Caliente', 'Débil', 'Deportes al aire libre'),
    ('Soleado', 'Frío', 'Débil', 'Deportes al aire libre'),
    ('Lluvioso', 'Fresco', 'Débil', 'Deportes al aire libre'),
    ('Soleado', 'Fresco', 'Fuerte', 'Deportes bajo techo'),
    ('Nublado', 'Fresco', 'Débil', 'Deportes bajo techo'),
    ('Nublado', 'Caliente', 'Fuerte', 'Deportes al aire libre'),
    ('Lluvioso', 'Fresco', 'Fuerte', 'Deportes bajo techo'),
]

# Atributos (Clima, Temperatura, Viento)
attributes = [0, 1, 2]
