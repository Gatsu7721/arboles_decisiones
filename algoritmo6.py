...
# Datos de ejemplo (Número de compras, Valor total de compras, Frecuencia de compra, Categoría de cliente)
data = [
    (5, 1000, 'Mensual', 'Clientes potenciales'),
    (1, 200, 'Anual', 'Clientes no potenciales'),
    (3, 400, 'Trimestral', 'Clientes potenciales'),
    (7, 1500, 'Mensual', 'Clientes potenciales'),
    (2, 300, 'Anual', 'Clientes no potenciales'),
    (4, 800, 'Trimestral', 'Clientes potenciales'),
    (1, 150, 'Anual', 'Clientes no potenciales'),
    (6, 1200, 'Mensual', 'Clientes potenciales'),
]

# Atributos (Número de compras, Valor total de compras, Frecuencia de compra)
attributes = [0, 1, 2]
