...
# Datos de ejemplo (Color, Textura, Origen, Tipo de Alimento)
data = [
    ('Rojo', 'Suave', 'Nacional', 'Frutas'),
    ('Verde', 'Rugoso', 'Extranjero', 'Verduras'),
    ('Amarillo', 'Suave', 'Nacional', 'Frutas'),
    ('Verde', 'Rugoso', 'Extranjero', 'Frutas'),
    ('Rojo', 'Suave', 'Nacional', 'Frutas'),
    ('Verde', 'Rugoso', 'Extranjero', 'Verduras'),
    ('Amarillo', 'Suave', 'Nacional', 'Frutas'),
    ('Verde', 'Rugoso', 'Extranjero', 'Proteínas'),
    ('Rojo', 'Suave', 'Nacional', 'Proteínas'),
    ('Rojo', 'Rugoso', 'Extranjero', 'Proteínas'),
    ('Verde', 'Suave', 'Nacional', 'Frutas'),
    ('Amarillo', 'Rugoso', 'Extranjero', 'Verduras'),
]

# Atributos (Color, Textura, Origen)
attributes = [0, 1, 2]
